...
public final class ActivityAuthenticationBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout frameAuthentication;

  private ActivityAuthenticationBinding(@NonNull ConstraintLayout rootView,
      @NonNull FrameLayout frameAuthentication) {
    this.rootView = rootView;
    this.frameAuthentication = frameAuthentication;
  }
  ...
  public static ActivityAuthenticationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.frame_authentication;
      FrameLayout frameAuthentication = ViewBindings.findChildViewById(rootView, id);
      if (frameAuthentication == null) {
        break missingId;
      }

      return new ActivityAuthenticationBinding((ConstraintLayout) rootView, frameAuthentication);
    }
