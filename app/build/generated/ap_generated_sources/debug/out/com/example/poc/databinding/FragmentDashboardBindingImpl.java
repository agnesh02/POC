...
public class FragmentDashboardBindingImpl extends FragmentDashboardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.dashboard_grid, 1);
        sViewsWithIds.put(R.id.card_weather, 2);
        sViewsWithIds.put(R.id.card_bluetooth, 3);
        sViewsWithIds.put(R.id.card_profile, 4);
        sViewsWithIds.put(R.id.card_stream, 5);
        sViewsWithIds.put(R.id.attendence, 6);
    }
    // views
    @NonNull
